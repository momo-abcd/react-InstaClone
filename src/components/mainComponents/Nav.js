...
const Nav = (props) => {
    const glass = {
        backgroundImage:`url('/images/searchGlass2.png')`
    }
    const searchGlassDom = useRef();
                ...
                <div className="navContainer">
                    ...
                    <div className="search">
                        ...
                        <div className="searchInput" >
                            ...
                            <label  id="searchText" htmlFor="search">검색</label>
                        ...
                        <div className="menu">
                            ...
                            {/* <div className="menuList">
                                ...
                                <img width="22px" height="22px" src="/images/basicProfile.jpg" />
                            </div> */}
                            {/* 이부분은 NavList로 빼서 로그인 햇을 때, 아닐 때 구분해서 랜더링 */}
                        </div>
                </div>
            </div>
        </nav>
